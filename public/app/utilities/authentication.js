...
factories.authenticationService = ['$q', 'SessionService', 'User', 'API', 'Restangular', 'FlashService', '$state',
	function($q, SessionService, User, API, Restangular, FlashService, $state) {
