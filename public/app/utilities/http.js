...
factories.API = ['$http', '$q', 'SanitizeService', 'FlashService', 'CSRF_TOKEN',
	function($http, $q, SanitizeService, FlashService, CSRF_TOKEN){
...
factories.Interceptors = ['CSRF_TOKEN', 'SanitizeService',
	function(CSRF_TOKEN, SanitizeService) {
