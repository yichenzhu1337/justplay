...
controllers.activityListDateController = ['$scope','$location','$anchorScroll','$filter','filterRegex','DateTimeService',
  function($scope, $location, $anchorScroll, $filter, filterRegex, DateTimeService) {
