var mod = angular.module('jp.friend', 
	['jp.friend.status.config','jp.api.config','jp.notifications.config','jp.http','jp.authentication','ui.router']);
var services= {};
var directives = {};

services.FriendService = function(friend_statuses, api_const, notification_routes, API) {
	var base_friend_url = api_const.base_api_route+'/'+api_const.friends;
	var base_notification_url = api_const.base_api_route+'/'+api_const.notifications+'/'+notification_routes.friends.request;
